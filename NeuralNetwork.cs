...
//                {
//                    if (previouslayer.layer[j].weight.Count < i + 1)
//                    {
//                        previouslayer.layer[j].weight.Add((float)Math.Round(random.NextDouble(), 5));
//                    }
//                    sum += (previouslayer.layer[j].value * previouslayer.layer[j].weight[i]);
//                }
...
//                    //Console.WriteLine("Layer Number: " + currentLayer.layernumber + " & Neuron Number: " + i + " with respect to " + j);
//                    //Console.WriteLine(dtotalerrorbycurrentvalue + " " + dcurrentvalyebyrawvalue + " " + dcurrentvalyebyrawvalue + " " + derrortotalby);
//                    Console.WriteLine(previousLayer.layer[j].weight[i] + " - " + learningRate + " * " + derrortotalby + " = " + (float)(previousLayer.layer[j].weight[i] - learningRate * derrortotalby));
//                    previousLayer.layer[j].weight[i] = (float)(previousLayer.layer[j].weight[i] - learningRate * derrortotalby);
//                }
//            }
//            //CalculateTotalError(currentLayer);
//            //currentLayer.Display();
//        }

//        public void BackwardPass(Layer previousLayer, Layer currentLayer, Layer nextLayer)
//        {
//            Console.WriteLine("Mid Nodes");
//            for (int i = 0; i < currentLayer.layer.Length; i++)
//            {
//                for (int j = 0; j < previousLayer.layer.Length; j++)
//                {
...
//            layers.layers[0].SetLayerNumber(1);
//            layers.layers[1].SetLayerNumber(2);
//            layers.layers[2].SetLayerNumber(3);
//            layers.layers[3].SetLayerNumber(4);
...
//            Console.WriteLine("Testing Expected out is 1");
//            layers.layers[0] = InputLayer1();
//            layers.Propogation(layers.layers[0], 1);
